...
export default function DetailAsset({ params }) {
  ...
  const fetch_data_service = async () => {
    const apiUrl = `${API_URL}/fetchassetservice?page=1`;
    const response = await axios.post(apiUrl, {
      idAsset: params.idAsset,
      keyword: keyword,
    });
                    ...
                    <div className="p-2">
                      <div className="bg-form-strokedark p-2">
                        <div className="flex flex-row justify-between">
                          <div>Issued</div>
                          <div>{formatDateTime(selectedCase.Time_Request)}</div>
                        </div>
                        <div className="flex flex-row justify-between">
                          <div>Response</div>
                          <div>
                            {formatDateTime(selectedCase.Time_Response)}
                          </div>
                        </div>
                        <div className="flex flex-row justify-between">
