            ...
            {dataOpname.map((item, index) => {
              return (
                <tr key={index}>
                  ...
                  <td className="text-center text-xs">{item["initial"]}</td>
                  <td className="text-center text-xs">{item["in"]}</td>
                  <td className="text-center text-xs">{item["out"]}</td>
                  <td className="text-center text-xs">{item["balance"]}</td>
                </tr>
              );
            })}
          </tbody>
