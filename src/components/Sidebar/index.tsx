...
const menuGroups = [
  {
    ...
    menuItems: [
...

      {
        ...
        consumer: "private",
        children: [
          { label: "Service", route: "/listservice" },
          { label: "Maintenance", route: "/listroutine" },
          { label: "EDP", route: "/listedp" },
        ],
      },
      ...
      },
      {
        ...
        consumer: "private",
        children: [
          { label: "Monthly Report", route: "/reportservice" },
          { label: "Quality Objective", route: "/qualityobjective" },
        ],
      },
      /*
      {
